...
#else
#error "please select first the system clock in system_gd32h7xx.c file"
#endif
...
static void sram01_mem_sections_initialise(void)
{
    /* Load DMA_DATA variable intializers into SRAM0/1 RAM */
...
void SystemInit(void)
{
    ...
    nvic_vector_table_set((uint32_t)&isr_vector_table_flash_base, 0x0);
#endif

    sram01_mem_sections_initialise();

...
STDPERIPH_DIR   = $(LIB_MODULES_DIR)/GD32H7/Firmware/GD32H7xx_standard_peripheral
USB_LIB_DIR    := $(LIB_MODULES_DIR)/GD32H7/Firmware/GD32H7xx_usbhs_library
...
VPATH        := $(VPATH):$(CMSIS_DIR)/Core/Include:$(LIB_MODULES_DIR)/GD32H7/Firmware/CMSIS/GD/GD32H7xx/Source
